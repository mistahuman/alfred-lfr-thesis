...
set ylabel "Inserzione reattivita [pcm]"
...
pl 'reattivita.dat' u 4:5 t 'Tf=550 [Celsius]' w lp ls 1, 'reattivita.dat' u 4:6 t 'Tf=1000 [Celsius]' w lp ls 2

set output '../graph/rods_temp.eps'
set terminal postscript eps color enhanced
replot

set xlabel "Temperatura [Celsius]"

pl 'reattivita.dat' u 1:2 t 'BOC' w lp ls 1, 'reattivita.dat' u 1:3 t 'EOC' w lp ls 2

set output '../graph/rods_burnup.eps'
set terminal postscript eps color enhanced
replot
