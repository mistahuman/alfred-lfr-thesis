...
set ylabel "Flusso Neutronico Medio [-]"
#set logscale y 10 
#set grid 
...
pl './data/fluxy.dat' u 1:2 t 'barre inserite (EOC)' w l ls 1, './data/fluxy.dat' u 1:3 t 'barre estratte (EOC)' w l ls 3

set output '../graph/fluxy.eps'
set terminal postscript eps color enhanced
replot


pl './data/fluxy_flat.dat' u 1:2 t 'barre inserite (EOC)' w l ls 1, './data/fluxy_flat.dat' u 1:3 t 'barre estratte (EOC)' w l ls 3

set output '../graph/fluxy_flat.eps'
set terminal postscript eps color enhanced
replot
